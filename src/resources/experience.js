export const experience = [
{
    ...
    Developed rapport with clients, fostering an environment of trust and safety to discuss sensitive issues\
    Formulate plans, working iteratively to achieve client\'s goals'
},
{
    _id: '2',
    company: 'Coding Job',
